                ...
                if(dataSnapshot.exists()){
                    for (DataSnapshot child:dataSnapshot.getChildren()){
                        if (child.getKey().equals("customer")){
                            ...
                            if(!customerId.equals(currentUserId)){ //si es distinto sabremos que es un driver y no un customer
                        ...
                        if (child.getKey().equals("driver")){
                            ...
                            if(!driverId.equals(currentUserId)){
                                ...
                                displayCustomerRelatedObjects(); //Con esto hacemos exclusivo el rating al customer probar poner en el de arriba
                            }
                        }
